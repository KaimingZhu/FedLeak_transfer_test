...
This repository documents how we integrate the official [FedLeak implementation(Zenodo v1)](https://doi.org/10.5281/zenodo.15532456) into the [Breaching](https://github.com/JonasGeiping/breaching/) evaluation framework, in order to support a unified evaluation protocol across multiple Gradient Inversion Attack baselines.
...
- **Center-crop-based adaptation**
  ...
  - Implementation: [`centercrop_generator.py`](./centercrop_generator.py)
